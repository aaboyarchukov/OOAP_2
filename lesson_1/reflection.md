...
После анализа условно-эталонного решения, понял, что не стоит сразу писать рефлексию, а сначала сделать код с заданием.

В целом, мои примеры были корректные и верные, которые явно показывают раскрытие темы в коде.